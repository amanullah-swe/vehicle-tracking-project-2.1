...
//         height: '100vh',
//         backgroundColor: 'var(--backColorMainLightMode)'
//       }}
...
//                           <div className="content pl-8 mx-8" >
//                           <div className="d-flex flex-column">
//                         <div>
//                         <p className="dateInn pl-7" style={{color:'#8F4300', fontSize:'13.7px'}}>11-12-1970 00:05:01</p>
//                         </div>
...
//                           <div className="d-flex flex-column">
//                         <div>
//                         <p className="dateInn "style={{color:'#8F4300', fontSize:'13.7px'}}>11-12-1970 00:05:01</p>
//                         </div>
...
//                           <div className="d-flex flex-column">
//                         <div>
//                         <p className="dateInn pl-5"style={{color:'#8F4300', fontSize:'13.7px'}}>11-12-1970 00:05:01</p>
//                         </div>
...
//                           <div className="d-flex flex-column">
//                         <div>
//                         <p className="dateInn mx-8 "style={{color:'#8F4300', fontSize:'13.7px'}}>11-12-1970 00:05:01</p>
//                         </div>
...
//                   <div className="row">
//                     <div className="col-md-3">
//                       <label className="head">Order Number</label>
//                       <p className="Value">
//                         {orderDetails?.dispatch_package_order_number ?? "-"}
//                       </p>
//                     </div>
//                     <div className="col-md-3">
//                       <label className="head">Order Date & Time</label>
//                       <p className="Value">
//                         {DateDDMMYYYY(
//                           orderDetails?.dispatch_package_order_datetime ?? "-"
//                         )}
...
//                     </div>
//                     <div className="col-md-4">
//                       <label className="head">Payment Type</label>
//                       <p className="Value">
...
//                   <div className="row">
//                     <div className="col-md-3">
//                       <label className="head">Trip Name</label>
//                       <p className="Value">
...
//                     </div>
//                     <div className="col-md-4">
//                       <label className="head">Trip Time</label>
//                       <p className="Value">
...
//                 <div className="headingDetails">
//                   <div className="headingTxt">
//                     <p className="heading">Assigned Driver & Vehicle Details</p>
//                   </div>
//                 </div>
//                 <div className="DetailsSec">
//                   <div className="row">
//                     <div className="col-md-3">
//                       <label className="head">Driver Name</label>
//                       <p className="Value">{orderDetails?.driver_name ?? "-"}</p>
//                     </div>
//                     <div className="col-md-3">
//                       <label className="head">Driver Contact</label>
//                       <p className="Value">
//                         {orderDetails?.driver_mobile ?? "-"}
//                       </p>
//                     </div>
//                     <div className="col-md-2">
//                       <label className="head">Vehicle Category</label>
//                       <p className="Value">
...
// export default ViewOrdersShare;
