...
const TaxExpiryReport = () => {
 ...
 /*  const reportViewList = () => {
    ...
    if (requestData) {
      ...
      setOptionDownload("");
      simplePostCall(
        ApiConfig.GET_VEHICLE_TAX_EXPIRY_REPORT ,
  ...
  const reportViewList = (
    ...
    if (selelctedDrop === "month") {
      ...
      requestData = {
        format: OptionDownload,
        startdate:  latestDate(weekStart, "yyyy-MM-dd") /* ? latestDate(weekStart, "yyyy-MM-dd") : '2023-12-01' , */ ,
        enddate: latestDate(nextDate, "yyyy-MM-dd") /* ? latestDate(nextDate, "yyyy-MM-dd") :'2023-12-31', */ ,
        // fromtimeval: "",
        // totimeval: "",
        vehicle_id: VehicleId,
        // user_id: "",
    ...
    if (requestData) {
      ...
      simplePostCall(
        ApiConfig.GET_VEHICLE_TAX_EXPIRY_REPORT /* + LinkReport */,
        JSON.stringify(requestData)
      )
        .then((res) => {
          if (res?.result) {
              ...
              <div className="right-export-btn-section-wrapper">
                ...
                <thead className="tableHead">
                  <tr className="text-center">
                    ...
                    <th>{t("Vehicle Registration Number")}</th>
...
export default TaxExpiryReport;
