 ...
 /*  const getdistanceunit = localStorage.customer_distance_unit
  ...
  /* const reportViewList = () => {
    ...
    if (requestData) {
      ...
      // setOptionDownload("");
      simplePostCall(
        ApiConfig.GET_VEHICLE_INSURANCE_EXPIRY_REPORT ,
  ...
  const reportViewList = (
    ...
    if (requestData) {
      ...
      setOptionDownload("");
      simplePostCall(
        ApiConfig.GET_VEHICLE_INSURANCE_EXPIRY_REPORT /* + LinkReport */,
        JSON.stringify(requestData)
      )
        .then((res) => {
          if (res?.result) {
              ...
              <div className="right-export-btn-section-wrapper">
                ...
                <thead className="tableHead">
                  <tr className="text-center">
                    ...
                    <th>{t("Insurance Expiray Date")}</th>
...
export default InsuranceExpiryReport;
