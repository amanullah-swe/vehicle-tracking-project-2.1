...
const { Option } = Select;
const DriverLicenceExpiryReport = () => {
 ...
 /*  const reportViewList = () => {
    ...
    if (requestData) {
      ...
      setOptionDownload("");
      simplePostCall(
        ApiConfig.MANTENANCE_DRIVER_lICENCE_EXPIRY ,
  ...
  const reportViewList = (
    ...
    if (requestData) {
      ...
      setOptionDownload("");
      simplePostCall(
        ApiConfig.MANTENANCE_DRIVER_lICENCE_EXPIRY /* + LinkReport */,
        JSON.stringify(requestData)
      )
        .then((res) => {
          if (res?.result) {
                          ...
                          return (
                            <>
                              <tr className="text-center">
                                ...
                                <td>
                                  {itemlist.driver_licence_expire_date  }
                                </td>
                                {/* <td>
...
export default DriverLicenceExpiryReport;
