...
const { Option } = Select;
const VehicleFuelExpenseReport = () => {
...
// ////////////////////////////////////////// start old function comment by me/////////////////////////////////////////
  /* const reportViewList = () => {
    ...
    if (requestData) {
      ...
      setOptionDownload("");
      simplePostCall(
        ApiConfig.GET_VEHICLE_FUEL_EXPENSE_REPORT ,
...
// ////////////////////////////////////////// end old function comment by me/////////////////////////////////////////
// ////////////////////////////////////////// start new function /////////////////////////////////////////
const reportViewList = (
  date,
  firstmonth,
  ...
  if (requestData) {
    ...
    setOptionDownload("");
    simplePostCall(
      ApiConfig.GET_VEHICLE_FUEL_EXPENSE_REPORT /* + LinkReport */,
      JSON.stringify(requestData)
    )
      .then((res) => {
        if (res?.result) {
...
// ////////////////////////////////////////// end new function /////////////////////////////////////////
      ...
      <div id="cx-wrapper" className="Vehicle_inspition_dashboard heightFixed">
        ...
        <div className="col-lg-12 mt-0">
          <div className="UserTabel">
            ...
            {/* ////////////////////////////////previous headin section commented by me//////////////////////////////////  */}
 ...
 {/* //////////////////////////////////// New Heading section added by me//////////////////////////////////////////////////////////////////////////////*/}
 <div className="heading">
              <div>
                <p>
                  <p>
...
export default VehicleFuelExpenseReport;
