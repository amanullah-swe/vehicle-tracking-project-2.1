...
export default DataUsageViewReport;
...
const Component1 = () => {
    ...
    const reportViewList = (
        ...
        if (requestData) {
            ...
            setOptionDownload("");
            simplePostCall(ApiConfig.DATA_USAGE_REPORT_POST_LIST, JSON.stringify(requestData)).then((res) => {
                if (res.result) {
                        ...
                        <table className="table tableAdmin">
                            <thead className="tableHead">
                                <tr>
                                    ...
                                    <th className="w-2">{t("vehicle reg no")}</th>
                                    <th>{t("vehicle imei")}</th>
                                    <th>{t("vehicle sim card no")}</th>
                                    <th>{t("hardware name")}</th>
                                    <th>{t("data usage size")}</th>
                                </tr>
                            </thead>
                            {loading ? (
                                <Loader />
                                                ...
                                                return (
                                                    <>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                {itemlist.data_usage_size || itemlist.data_usage_size == 0
                                                                    ? itemlist.data_usage_size
                                                                    : ""}
                                                            </td>
                                                        </tr>
                                                    </>
