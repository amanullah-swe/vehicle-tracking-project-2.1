...
import dumyPersonIcon from '../../../../assets/images/dumyPersonIcon.png'
import { Select } from "antd";
const { Option } = Select;



const ViewMobileAppDetails = () => {
    return (
        <div>
            <Component1 />
        </div>
...
export default ViewMobileAppDetails;
...
const Component1 = () => {
    ...
    const reportViewList = (
        ...
        if (requestData) {
            ...
            setOptionDownload("");
            simplePostCall(ApiConfig.MOBILE_APP_DETAILS_VIEW, JSON.stringify(requestData)).then((res) => {
                if (res.result) {
                        ...
                        <table className="table tableAdmin">
                            <thead className="tableHead">
                                <tr>
                                    ...
                                    <th>{t("User name")}</th>
                                    <th>{t("User Role")}</th>
                                    <th className="w-2">{t("Apps Type")}</th>
                                    <th>{t("No: of Devices")}</th>
                                </tr>
                            </thead>
                            {loading ? (
                                <Loader />
                                                ...
                                                return (
                                                    <>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <img
                                                                    src={itemlist.user_profile_pic ? itemlist.user_profile_pic : dumyPersonIcon}
                                                                    width={50}
                                                                    height={50}
                                                            ...
                                                            <td>
                                                                {itemlist.user_name
                                                                    ? itemlist.user_name + " " + (itemlist.user_last_name ? itemlist.user_last_name : "")
                                                                    : ""}
                                                            </td>
                                                            <td>
                                                                {itemlist.user_role
