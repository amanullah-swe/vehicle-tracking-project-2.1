...
const SystemReportsAndStatisticsUsageAudit = () => {
    return (
        <div>
            <Component1 />
        </div>
...
export default SystemReportsAndStatisticsUsageAudit;
...
const Component1 = () => {
    ...
    const reportViewList = (
        ...
        if (requestData) {
            ...
            setOptionDownload("");
            simplePostCall(ApiConfig.SYSTEM_REPORT_USAGE_STATISTICS_SYSTEM_USAGE_AUDIT, JSON.stringify(requestData)).then((res) => {
                if (res.result) {
                    ...
                    <div className="UserTabel">
                        ...
                        <table className="table tableAdmin">
                            <thead className="tableHead">
                                <tr>
                                    <th>{t("Sr.no")}</th>
                                    <th>{t("Reports Access Log Url")}</th>
                                    <th className="w-2">{t("Reports Access Log Time")}</th>
                                    <th>{t("Reports Access Log Count")}</th>
                                </tr>
                            </thead>
                            {loading ? (
                                <Loader />
                                                ...
                                                return (
                                                    <>
                                                        <tr>
                                                            <td>{index + 1}</td>
                                                            <td>
                                                                {itemlist.reports_access_log_url
                                                                    ? itemlist.reports_access_log_url
                                                                    : ""}
                                                            </td>
                                                            <td>
                                                                {itemlist.reports_access_log_time
                                                                    ? itemlist.reports_access_log_time
                                                                    : ""}
                                                            </td>
                                                            <td>
                                                                {itemlist.reports_access_log_count
                                                                    ? itemlist.reports_access_log_count
                                                                    : ""}
                                                            </td>
                                                        </tr>
