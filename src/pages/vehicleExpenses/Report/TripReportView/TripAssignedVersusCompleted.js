...
const { Option } = Select;
const TripAssignedVersusCompleted = () => {
 ...
 /*  const getdistanceunit = localStorage.customer_distance_unit
  ...
  //     setOptionDownload("");
  //     simplePostCall(
  //       ApiConfig.TRIP_ASSIGNED_VERSUS_COMPLETED /* + LinkReport */,
  //       JSON.stringify(requestData)
  //     )
  //       .then((res) => {
  //         if (res?.result) {
      ...
      <div id="cx-wrapper" className="Vehicle_inspition_dashboard heightFixed">
        ...
        <div className="col-lg-12 mt-0">
          <div className="UserTabel">
            {/* start old header commented by me///////////////////////////////////////////////////////// */}
...
<div className="leftContent d-flex">
             ...
             {/* end old header commented by me///////////////////////////////////////////////////////// */}
        {/* start new header added by me///////////////////////////////////////////////////////// */}
     {/*    <div className="heading">
              <div>
                <p>
                  <p>
...
export default TripAssignedVersusCompleted;
