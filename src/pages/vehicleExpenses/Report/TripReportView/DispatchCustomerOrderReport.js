...
const DispatchCustomerOrderReport = () => {
              ...
              <div className="right-export-btn-section-wrapper">
                ...
                <thead className="tableHead">
                  <tr>
                    ...
                    <th className="w-2">{t("Report Date")}</th>
                    <th>{t("Vehicle Imei")}</th>
                    {/* <th>{t("Orders Pending")}</th> */}
                    {/* <th>{t(`Distance(${getdistanceunit})`)}</th> */}
                    <th>{t("DistanceWithUnit", { unit: translatedDistanceUnit })}</th>
                    {/* {vehicleSelect != "All" ? <th>{t("Repair Cost")}</th> : ""} */}
                    <th>{t("Actual Duty Time(hrs)")}</th>
                    {/* <th>{t(`Average Speed(${getdistanceunit + "/hr"})`)}</th> */}
                    <th>{t("Average Speed", {unit: translatedDistanceUnit})}</th>
                    {/* <th>{t(`Max Speed(${getdistanceunit + "/hr"})`)}</th> */}
...
export default DispatchCustomerOrderReport;
