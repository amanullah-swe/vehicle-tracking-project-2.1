                  ...
                  <div id='cx-wrapper'>
                                ...
                                {itemlist.user_status === 'active' ? (
                                  <>
                                    <Dropdown.Item
                                      ...
                                      onClick={() => {
                                        handleShowblock()
                                        setTransportBlock(itemlist.user_status)
                                      }}
                                      className='d-block'
                                    >
                                    ...
                                    <Dropdown.Item
                                      ...
                                      onClick={() => {
                                        handleShowresign()
                                        setTransportId(itemlist.user_status)
                                      }}
                                      className='d-block'
                                    >
                                      <Link to='#' className='d-block'>
                    ...
                    >
                      ...
                      <Modal.Body>
                        ...
                        {TransportId === 'active' ? 'Resign' : 'UnResign'} this
                        Transport Manager
                      </Modal.Body>
                    ...
                    >
                      ...
                      <Modal.Body>
                        Are you sure you want to{' '}
                        {TransportBlock === 'active' ? 'Block' : 'UnBlock'} this
                        Transport Manager
                      </Modal.Body>
                      <Modal.Footer className='pop-up-modal-footer'>
                        <div class='btn-wrapper'>
...
export default ViewTransportManager
