...
const Feature1 = () => {
  ...
  const { sidebar, useDebounce,setVehicleTabListActive } = useContext(AppContext);
            ...
            .then((res) => {
              setBottom(false)
                if (res.result==true) {
                    ...
                    tab === "tab" ? setFeatureCardData(data) : setFeatureCardData([...featureCardData,...data]);
        ...
        >
            <div id="cx-wrapper" className="Feature_set">
                ...
                <div className="haeder">
                     ...
                     <div className={featureListData?.length>0?"Feature_select":"Feature_select invisible "}>
                        <label
                            htmlFor=""
                            onClick={() => {
                    ...
                    <Link to="/AddVehicle" className="d-flex justify-content-end"  onClick={() => {
                                            ...
                                            {featureSubTab == featureSubTab &&
                                                ...
                                                <div className="card-contain col-lg-6 col-md-6 col-sm-6">
                                                 ...
                                                 Registraion No.
                                                  ...
                                                  <p className="title">{ele?.vehicle_model_no}</p>
                                                </div>
                                                <div className="card-contain col-lg-6 col-md-6 col-sm-6">
                                                  <p className="sub-heading">
                                                   Hardware Name
                                                  </p>
                                                  <p className="title">{ele?.hardware_name}</p>
                                                </div>
                                                <div className="card-contain col-lg-6 col-md-6 col-sm-6">
                                                  <p className="sub-heading">
                                                    IMEI No.
                                                ...
                                                <div className="card-contain col-lg-6 col-md-6 col-sm-6">
                                                  ...
                                                  <p className="title">{ele?.vehicle_type_code}</p>
                                                </div>
                                                {/* <div className="card-contain col-lg-6 col-md-6 col-sm-6">
                                                  <p className="sub-heading">
                                                    Transportation Type
