...
const FuelManagementDashbord = () => {
  ...
  const [circle, setCircle] = useState({
    ...
    options: {
      ...
      labels: ["Cab", "Pick-Up Truck", "Mini-Truck", "Luxury Car"],
      dataLabels: {
        enabled: false,
      },
      plotOptions: {
      ...
      colors: ["#454545", "#FFD1C7", "#FFA559", "#FF6000"],
      stroke: {
        width: 0,
      },
      //   tooltip: {
  ...
  const [circle1, setCircle1] = useState({
    ...
    options: {
      ...
      labels: ["Redbytes ", "Cloudxperte", "Apple", "Google"],
      dataLabels: {
        enabled: false,
      },
      plotOptions: {
      ...
      colors: ["#F9D949", "#926C6C", "#454545", "#FF6000"],
      stroke: {
        width: 0,
      },
      //   tooltip: {
  ...
  const [circle2, setCircle2] = useState({
    ...
    options: {
      ...
      colors: ["#0078AA", "#3AB4F2", "#F2DF3A", "#EF7F7F"],
      stroke: {
        width: 0,
      },
      //   tooltip: {
      ...
      <div id="cx-wrapper" className="FuelManagementDashbord">
        ...
        <div className="Graph_Section_second mb-4">
          <div className="row">
            ...
            <div className="col-lg-6">
              <div className="TopSpendsbyVehicles resposiveBottom">
                <div className="Heading_fule">
        ...
        <div className="ProgreeBar_main">
          <div className="row">
            ...
            <div className="col-lg-4">
              <div className="TopSpendCategories">
                <div className="Heading_fule">
                  <p className="heading">{t("Top Spend Groups")}</p>
                </div>
                <div className="single_card_TopSpendCategories">
                  <p className="title">{t("Total Spend by")}</p>
                  <p className="amount">Redbytes</p>
                </div>
                <div className="circle_chart">
                  <Chart
            ...
            <div className="col-lg-4">
              <div className="TopSpendCategories">
                <div className="Heading_fule">
                  <p className="heading">{t("Top Spend Fuels")}</p>
                </div>
                <div className="single_card_TopSpendCategories">
                  <p className="title">{t("Total Spend by")}</p>
                  <p className="amount">Petrol</p>
                </div>
                <div className="circle_chart">
                  <Chart
                    options={circle2.options}
...
export default FuelManagementDashbord;
